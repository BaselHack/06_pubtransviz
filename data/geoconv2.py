...
class GPSConverter2(object):
    def CHtoWGSlat(self,x,y):
        """
    ...
    def CH1903toWGS1984(self,x, y):
      ...
      lat = self.CHtoWGSlat(x, y)
      lng = self.CHtoWGSlng(x, y)
    ...
    if __name__ == "__main__":
        ...
        var = CH1903toWGS1984(266874, 607952)
        print (var)
